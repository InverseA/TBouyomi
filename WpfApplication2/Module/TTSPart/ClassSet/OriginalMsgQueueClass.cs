...
namespace Twitch_Bouyomi
{
    ...
    class OrignalMsg_object
    {
        ...
        public void SetPremium(bool state)
        {
            _IsPremium = state;
        }
        ...
        {
            //@badges=staff/1,bits/1000;bits=100;color=;display-name=dallas;emotes=;id=b34ccfc7-4977-403a-8a94-33c6bac34fb8;mod=0;room-id=1337;
            //subscriber =0;turbo=1;user-id=1337;user-type=staff :ronni!ronni@ronni.tmi.twitch.tv PRIVMSG #dallas :cheer100
            ...
            if(_OriMsg.Contains("PRIVMSG"))
            {
                ...
                if (_tag_info.Contains("bits="))
                {
                    ...
                    _BitsTotal = _temp.Remove(_count);  //Set Total Bit.
            ...
            else if (_OriMsg.Contains("USERNOTICE"))
            {
                ...
                if (_tag_info.Contains("msg-id="))
                {
                    ...
                    if(_Msgid_string == "sub" || _Msgid_string == "resub")
                    {
                        ...
                        while(_temp[_count] != ';')
                        {
                            _SubMsg += _temp[_count];   //Set Sub Msg.
                            _count++;
                        }
                        ...
                        while (_temp[_count] != ';')
                        {
                            _talker += _temp[_count];   //Set Who Sub.
                            _count++;
                        }
                    }
                }
